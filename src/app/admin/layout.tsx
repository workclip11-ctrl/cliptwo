...
import { LayoutGrid, Users, Film, Megaphone, Globe, Server, ShieldAlert, History, Banknote, FlaskConical, Menu } from "lucide-react";
...
const NAV = [
  ...
  { href: "/admin/payouts/test", label: "Test Sandbox", icon: FlaskConical },
