...
const CLIPPER_JOURNEY = [
  ...
  { num: "03", label: "Add your UPI ID", title: "Set up your payout", body: "Add the UPI ID you want earnings sent to. One-time setup, verified by our team, used for every campaign after.", visual: "payout" },
