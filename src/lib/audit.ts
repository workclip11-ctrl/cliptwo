...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  campaign_payment_submitted: "Campaign payment submitted",
  campaign_payment_verified: "Campaign payment verified",
  campaign_payment_rejected: "Campaign payment rejected",
