...
-- Do NOT define it here — re-running would create the obsolete 37-param
-- overload that accepts p_status and allows status='open' at creation.
...
--
-- SUPERSEDED: This definition is historical/legacy. The authoritative version
-- is in campaign-state-machine-phase1.sql which runs later in execution order.
-- Do NOT re-execute this definition as it would overwrite the hardened version.
-- ---------------------------------------------------------------------------

-- [DEFINITION REMOVED] This function is defined in campaign-state-machine-phase1.sql
...
--
-- SUPERSEDED: This definition is historical/legacy. The authoritative version
-- is in financial-rewrite.sql which runs later in execution order.
-- Do NOT re-execute this definition as it would overwrite the hardened version.
-- ---------------------------------------------------------------------------

-- [DEFINITION REMOVED] This function is defined in financial-rewrite.sql
...
--
-- SUPERSEDED: This definition is historical/legacy. The authoritative version
-- is in campaign-launch-payments.sql which runs later in execution order.
-- Do NOT re-execute this definition as it would overwrite the hardened version.
-- ---------------------------------------------------------------------------

-- [DEFINITION REMOVED] This function is defined in campaign-launch-payments.sql
