...
create table public.campaigns (
  ...
  constraint campaigns_created_by_not_null check (created_by is not null) deferrable initially deferred
);
...
create table public.clips (
  ...
  constraint clips_user_id_not_null check (user_id is not null) deferrable initially deferred
);
