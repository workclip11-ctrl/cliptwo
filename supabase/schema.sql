...
insert into public.clips (campaign_id, clipper, caption, video_url, platform, views, status, rejection_reason, rejection_details)
values
  ('11111111-1111-1111-1111-111111111111', 'maya.cuts', 'This app is unhinged #tech', 'https://instagram.com/reel/xk29a', 'Instagram', 18400, 'paid', null, null),
  ('11111111-1111-1111-1111-111111111111', 'devon.edits', 'The keynote moment everyone missed', 'https://youtube.com/shorts/8kd92', 'YouTube', 0, 'pending', null, null),
  ('22222222-2222-2222-2222-222222222222', 'maya.cuts', '3 moves that fixed my posture', 'https://instagram.com/reel/pw001', 'Instagram', 0, 'pending', null, null),
  ('11111111-1111-1111-1111-111111111111', 'maya.cuts', 'The keynote but with a loud soundtrack', 'https://instagram.com/reel/xk44b', 'Instagram', 6200, 'rejected', 'Campaign rule violation', 'Background music was not allowed for this campaign.');
